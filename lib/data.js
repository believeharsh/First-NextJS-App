...
export const users = [
  {
    ...
    profilePicture: 'https://via.placeholder.com/150/0000FF/FFFFFF?text=JD', // Blue background, white text
  },
  {
    id: 'user2',
    ...
    profilePicture: 'https://via.placeholder.com/150/FF0000/FFFFFF?text=JS', // Red background, white text
  },
  {
    id: 'user3',
    ...
    profilePicture: 'https://via.placeholder.com/150/008000/FFFFFF?text=AC', // Green background, white text
  },
];
...
export const posts = [
  {
    ...
    imageUrl: 'https://via.placeholder.com/600x400?text=Coffee+Time',
  ...
  },
  {
    ...
    imageUrl: 'https://via.placeholder.com/600x400?text=Next.js+App+Router',
  ...
  },
  {
    ...
    imageUrl: 'https://via.placeholder.com/600x400?text=Coding+Session',
  ...
  },
  {
    ...
    imageUrl: 'https://via.placeholder.com/600x400?text=Workout+Motivation',
